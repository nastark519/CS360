...
# let it be noted that most of the work for this part was done on my own but that 
# the solution file was need in order to finish properly. That is I got most of it working and 
# then broke the code beyond repair and then read over to understand the solution.
...
def extract_names(filename):
  ...
  """
  names = [] # An empty list for outr compiler to know what we are using

  # Open and read the file.
  f = open(filename) # I took out the Ur because its assumed that the file will be just read.
  text = f.read()
